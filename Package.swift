...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/AstroQore/agent-session-kit.git", exact: "0.11.0-museagent.1"),
        ...
        .package(url: "https://github.com/AstroQore/vibe-bar-i18n.git", exact: "0.19.0-museagent.1"),
